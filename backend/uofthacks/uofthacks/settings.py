"""
Django settings for uofthacks project.
...
SECRET_KEY = '1(-8refe^gc)%=0@2mux@qc6fzt)(#j&2pe4qh&(ns$vnv)q(*'
...
WSGI_APPLICATION = 'uofthacks.wsgi.application'
